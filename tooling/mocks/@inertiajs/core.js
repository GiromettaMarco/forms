...
var CurrentPage = class {
  ...
  // @MOCK disable swapComponent and resolveComponent methods
  swapComponent = (args) => new Promise((resolve) => resolve())
  resolveComponent = (component, page) => null
  onFlashCallback;
  componentId = {};
  listeners = [];
...
var Router = class {
  ...
  performClientVisit(params, { replace = false } = {}) {
    ...
    return page.set(page2, {
      ...
      fireClientVisitEvent(page.get(), { replace, visitId });
